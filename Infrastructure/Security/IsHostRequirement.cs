    ...
    : AuthorizationHandler<IsHostRequirement>
{
    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, IsHostRequirement requirement)
    {
        ...
        // This line of code is checking to see if the value returned is not a string then it will return.
        // If the value is a string then the value is assigned to activityId.  
        // Example of a pattern matching expression
